...
public class Stats {
    ...
    private static final String TAG = "LauncherJiayu/Stats";

    private static final boolean LOCAL_LAUNCH_LOG = true;

    public static final String ACTION_LAUNCH = "com.android.launcher2.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.android.launcher2.permission.RECEIVE_LAUNCH_BROADCASTS";
