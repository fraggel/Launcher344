...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources,
        ...
        double calc= jiayuLauncherConfigEscritorio.calcularPercentFormula(Utils.getSharedPreferencesInt(context, "workspace_icons",  resources.getInteger(R.integer.workspace_icons)));
        calc=calc/100;
        double calc2= jiayuLauncherConfigInferior.calcularPercentFormula(Utils.getSharedPreferencesInt(context, "hotseat_icons",  resources.getInteger(R.integer.hotseat_icons)));
        calc2=calc2/100;
        double calc3= jiayuLauncherConfigCajon.calcularPercentFormula(Utils.getSharedPreferencesInt(context, "allapps_icons",  resources.getInteger(R.integer.allapps_icons)));
        calc3=calc3/100;
