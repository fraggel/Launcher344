...
public class InstallShortcutReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_INSTALL_SHORTCUT =
            "com.fraggel.launcher.action.INSTALL_SHORTCUT";
    /// M: Add for Message Shortcut (batch)
    private static final String EXTRA_SHORTCUT_INTENT_ARRAY = "com.fraggel.launcher.extra.shortcut.array.INTENT";
    private static final String EXTRA_SHORTCUT_NAME_ARRAY = "com.fraggel.launcher.extra.shortcut.array.NAME";
    private static final String EXTRA_SHORTCUT_ICON_ARRAY = "com.fraggel.launcher.extra.shortcut.array.ICON";
    private static final String EXTRA_SHORTCUT_ICON_RESOURCE_ARRAY = "com.fraggel.launcher.extra.shortcut.array.ICON_RESOURCE";
    private static final String EXTRA_SHORTCUT_TOTAL_NUMBER = "com.fraggel.launcher.extra.shortcut.totalnumber";
    private static final String EXTRA_SHORTCUT_STEP_NUMBER = "com.fraggel.launcher.extra.shortcut.stepnumber";
