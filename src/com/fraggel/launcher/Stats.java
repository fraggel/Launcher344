...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.fraggel.launcher.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.fraggel.launcher.permission.RECEIVE_LAUNCH_BROADCASTS";
