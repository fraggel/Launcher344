...
import com.fraggel.launcher.FolderIcon.FolderRingAnimator;
import com.fraggel.launcher.Launcher.CustomContentCallbacks;
import com.fraggel.launcher.LauncherSettings.Favorites;
    ...
    protected void notifyPageSwitchListener() {
        ...
        if (hasCustomContent() && getNextPage() == 0 && !mCustomContentShowing) {
            ...
            if (mCustomContentCallbacks != null) {
                ...
                if(Utils.getSharedPreferencesBoolean(getContext(),"show_google_bar",getResources().getBoolean(R.bool.show_google_bar))){
